...
<style-scheme id="arc-dark" _name="Arc Dark" version="1.0">
  <author>lbcnz</author>
  <_description>Color scheme based on arc-theme dark.</_description>

  <!-- Dark Palette -->
  <color name="base03"  value="#38424A"/>
  <color name="base02"  value="#323843"/>
  <color name="base01"  value="#eceff1"/>
  ...
  <color name="yellow"  value="#ffc107"/>
  <color name="orange"  value="#FC8C4C"/>
  <color name="red"     value="#ff4d00"/>
  <color name="magenta" value="#e91e63"/>
  <color name="violet"  value="#ad1457"/>
  <color name="blue"    value="#03a9f4"/>
  <color name="cyan"    value="#00C9BC"/>
  <color name="green"   value="#8bc34a"/>
